...
//            $user->is_login = '0';
//            $user->save();
//            dd(\Auth::id(),$request->device_token,\App\UserDevice::where('user_id', \Auth::id())->where('token', $request->device_token)->count());
