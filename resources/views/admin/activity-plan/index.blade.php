        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card-body">
                            ...
                            <a href="{{ url('/admin/activity-plan/create') }}" class="btn btn-success btn-sm" title="Add New ActivityPlan">
...
<script type="text/javascript">
    ...
    processing: true,
            serverSide: true,
            ajax: "{{ route('activity-plan.index') }}",
            columns: [
            {data: 'id', name: 'id'},
<?php foreach ($rules as $rule): ?>
    <?php if ($rule == 'email'): ?>
...
//       alert('a');
    ...
    var form_data = new FormData();
            ...
            $.ajax({
            url: "{{route('activity-plan.changeStatus')}}",
                    method: "POST",
                    data: form_data,
                    contentType: false,
                    cache: false,
