                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ url('/admin/class-schedule/create') }}" class="btn btn-success btn-sm" title="Add New Class Schedule">
...
<script type="text/javascript">
    $(function () {
        ...
        lengthMenu: "_MENU_",
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('class-schedule.index') }}",
                columns: [
                {data: 'id', name: 'id'},
<?php foreach ($rules as $rule): ?>
    <?php if ($rule == 'email'): ?>
...
//       alert('a');
    ...
    var form_data = new FormData();
            ...
            $.ajax({
            url: "{{route('class-schedule.changeStatus')}}",
                    method: "POST",
                    data: form_data,
                    contentType: false,
                    cache: false,
