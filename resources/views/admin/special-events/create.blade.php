    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card">
                    <div class="card-header">Create New Special Event</div>
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => '/admin/special-events', 'class' => 'form-horizontal', 'files' => true]) !!}

                        @include ('admin.special-events.form', ['formMode' => 'create'])
